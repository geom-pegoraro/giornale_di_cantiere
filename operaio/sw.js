...
const CHANGELOG = {
  '1.3.0': {
    title: '📂 Report in formato .json',
    items: [
      'File .json: importabile direttamente nell'app capocantiere',
      'Download automatico al momento della firma',
      'Report firmati: click funzionante',
      'Pulizia automatica dati dopo 7 giorni'
    ]
  },
  '1.2.0': {
